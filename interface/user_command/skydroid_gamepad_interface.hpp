...
public:
    SkydroidGamepadInterface(int port, RobotName robot_name=RobotName::CR1LEG):UserCommandInterface(robot_name){
...
void SkydroidGamepadInterface::TransformSkydroidToUserCommand(){
    while (transform_cmd_flag_) {
        ...
        usr_cmd_->time_stamp = sd_keys_.time_stamp;
        ...
        if (!IsKeysEqual(sd_keys_, sd_keys_record_)) {
            ...
            case RobotMotionState::StandingUp:
                ...
                if(sd_keys_.D != sd_keys_record_.D){
