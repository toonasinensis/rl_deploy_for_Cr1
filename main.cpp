 ...
 * @LastEditTime: 2025-08-20 16:40:05
 * 
...
int main(){
    ...
    std::shared_ptr<StateMachineBase> fsm = std::make_shared<humanoid::HumanoidStateMachine>(RobotName::CR1Standard, RemoteCommandType::kKeyBoard);
