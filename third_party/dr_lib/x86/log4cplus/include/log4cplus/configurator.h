...
namespace log4cplus
{
    ...
    && defined (UNICODE)
        ...
        static void SetFilePathWithName(const log4cplus::tstring &path, const log4cplus::tstring &fileName){
          file_name_ = fileName;
          file_path_ = path;
        }
        static log4cplus::tstring file_name_;
        static log4cplus::tstring file_path_;
        /**
