...
#define LOG4CPLUS_MACRO_NOTICE_LOG_LEVEL(pred) \
    LOG4CPLUS_LIKELY (pred)
...
#if !defined(LOG4CPLUS_DISABLE_NOTICE)
#define LOG4CPLUS_NOTICE(logger, logEvent)                                \
    LOG4CPLUS_MACRO_BODY (logger, logEvent, NOTICE_LOG_LEVEL)
#define LOG4CPLUS_NOTICE_STR(logger, logEvent)                            \
    LOG4CPLUS_MACRO_STR_BODY (logger, logEvent, NOTICE_LOG_LEVEL)
#define LOG4CPLUS_NOTICE_FMT(logger, ...)                                 \
    LOG4CPLUS_MACRO_FMT_BODY (logger, NOTICE_LOG_LEVEL, __VA_ARGS__)
